...
<img width={450} height={300} src="https://wordpressfreezonex.oss-accelerate.aliyuncs.com/4.2/supos/202.png" />
<table>
<thead>
<tr>
<th>
...
<td>Select a person to be informed when the workflow comes to this step.</td>
</tr>
<tr>
<td>
Event binding
...
<td>Enable it to allow adding informed person during operation center when executor start the task.</td>
</tr>
<tr>
<td>
New countersign
