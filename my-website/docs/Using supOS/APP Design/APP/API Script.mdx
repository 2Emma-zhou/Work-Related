...
- registerReactDom
<ul><li>Usage: Register as a **ReactDom** in **Programmable Component**, and then can be called by using the component in business designer.</li>
<li>Parameter
...
- logoutReactDom
<ul><li>Usage: Logout the registered **ReactDom** instance in **Programmable Component**, and often can be called in the lifecycle of **componentWillUnmount** to release storage.</li>
<li>Parameter
<ul><li>(component): Component instance.</li>
<li>(object): Props.</li>
</ul>
