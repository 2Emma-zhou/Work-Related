...
All instances in this manual are used with two types of templates: user template and absence template.

* user: Form template displaying staff information with name space of supos\_employ. Attributes are as follows.
...
* absence: Form template of note for leave with name space of supos\_employ. Attributes are as follows:
...
## Printing sql syntax generated by jsql
...
* templateNamespace：name space of template
...
```
// Select all the staff who are older than 30 and younger than 20 (including 20 and 30)
