...
You can either collect data from edge devices through supCollector, or connect a third-party database to the supOS platform and call data through template services.
## Connecting Database
1. Log in to the supOS platform, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/7.png) to enter the design center.
2. Select **Global Configuration** > **Data Source Management** on the left side in design center, and then click **New**.<br/>
You can select a type of database according to actual situation. MySQL is used as an example in this chapter.
3. Select **mySQL**, and then enter the basic information of the database.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/79.png)
...
2. Select **Form Template**, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/28.png).
    - **Entity Template** is often used to describe data collected through supCollector.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/81.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/80.png)
