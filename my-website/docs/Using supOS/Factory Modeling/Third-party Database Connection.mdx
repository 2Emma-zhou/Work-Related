...
## Connecting Database
1. Log in to the supOS platform, and then click ![](https://wordpressfreezonex.oss-accelerate.aliyuncs.com/platform/7.png) to enter the design center.
...
![](https://wordpressfreezonex.oss-accelerate.aliyuncs.com/platform/79.png)
...
![](https://wordpressfreezonex.oss-accelerate.aliyuncs.com/platform/81.png)
