...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/52.png)
- File data source
<ul>
<ul>
...
:::info
When the input data source is file, the published task reads the file and output results again if any changes happen on the file.
:::

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/53.png)
- API data source
...
Variables can be configured in the request URL, request headers, and JSON text, and the variable must exist in the task global variables.
    ...
    <tr>
<td>Request address variable</td>
<td>Use <b>#{}</b> to identify variables.</td>
    </tr>
    <tr>
<td>Request header parameter variable</td>
<td>Select Variable as the Processing method, and select the value. You can enable Circular traversal and </td>
    </tr>
    <tr>
<td></td>
<td></td>
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/54.png)
### Message Queue Input
Collects data from message queue and map it to a 2-demension table, and delivers to downstream operators for processing.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/55.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/56.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/57.png)

### SQL Execution
Uses SQL statements to perform simple operations such as insert, delete and update on the relational data sources.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/58.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/59.png)

### Data Filtering
Multiple filter conditions are avaliable for a single field, and data that meets all conditions will be filtered.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/60.png)

### Data Connection
Integrates data from multiple tables to one.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/61.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/62.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/63.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/64.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/65.png)

### Data Completion

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/66.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/66-1.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/67.png)

### Data Aggregation

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/68.png)
...
2. Select fields of numberic type, and then click **Add aggregated field** to add fields to be aggregated.
...
![Aggregate by time](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/68-1.png)
![Aggregate by data record](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/68-2.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/69.png)
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/69-1.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/70-1.png)

- Debug the script to make sure the result is reasonable.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/70.png)

## Big Data Model
### Model Operation
Runs big data model of supOS and output the results.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/71.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/73.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/74.png)

## Security Desentization
By using data obfuscation to process multiple fields, the obfuscated data will overwrite the original data and flow to downstream operators.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/75.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/76.png)

- File data source

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/77.png)

- API data source

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/78.png)

### Message Queue Output
Kafka, mQTT and RocketMQ are supported.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/79.png)

### Data Warehouse Output

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/80.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supETL/81.png)
