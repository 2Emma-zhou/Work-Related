...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supEdge/3.png)
...
4. Click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supEdge/4.png) of the video source you added, and set the algorithm to analyze it.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supEdge/5.png)
