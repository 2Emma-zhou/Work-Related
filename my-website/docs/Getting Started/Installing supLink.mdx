supLink can be installed directly on server by command statements or through visual installation package.
:::info
...
- Resource fights between supOS and supLink may cause issues.
:::
...
```
2. Inside the package, install supLink.
```
...
Specify the authorization information of supLink for normal use.
...
- Authorization address: The IP of the authorization dongle server.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supLink/3.png)

3. Click **OK**, and then click **Restart Service** at the upper-left corner.

## Visual Installation
:::info
Visual installation is available for V3.10.02.00-C and later version.
:::

1. Double-click the installation file, and then start installing.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supLink/1.png)

3. Enter the server information on which the supLink will be installed.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supLink/2.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supLink/4.png)
...
```
- Uninstall supLink through the visual installation file by indicating the specific information of supLink server.