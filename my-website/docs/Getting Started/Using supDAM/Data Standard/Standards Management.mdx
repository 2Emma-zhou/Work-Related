Add standard set and new standards for subsequent quality check on added data sources.

### Adding Standard Set
1. Log in to supOS, and then Select **Data Intelligence** > **Data Governance** > **Data standards** > **Standards Management**.
2. Click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supDAM/17.png) to add a new standard set.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supDAM/18.png)
...
### Adding Standard
1. elect the standard set, click **New standard**.
2. Enter information of the selected attributes, and then click **Confirm**.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/supDAM/19.png)
