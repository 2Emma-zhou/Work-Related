...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/16.jpg)
## Configuring DCOM 
...
:::
### Preparation
- Install and configure the operation system according to installation guide and standards.
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/1.jpg)
3. Set computer properties.
- Default Properties<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/2.jpg)
- Default Protocols<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/3.jpg)
- COM Security<br/>
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/4.jpg)<br/>
...
- General<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/5.jpg)
- Location<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/6.jpg)
- Security <br/>
Change all three types of permissions to grant to the following users.<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/7.jpg)
<ul>
<li>Everyone</li>
<li>Interactive</li>
<li>ANONYMOUSLOGIN</li>
...
- Endpoints<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/8.jpg)
- Identity<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/9.jpg)
:::tip
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/10.jpg)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/11.jpg)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/12.jpg)
:::tip
Double-click the service and then click **Start** if the service is not running.
:::
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/13.jpg)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/14.jpg)<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/15.jpg)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/17.jpg)
4. Select **OPC** > **Add Item**.<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/18.jpg)
:::info
...
1. Log in to supCollector, and then select **RTD Collector** > **Source**.<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/1.gif)
2. Synchronize tags connected to the source point.<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/2.gif)
:::info
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/3.gif)
4. On supCollector, select **RTD Collector** > **Connection Info** and then connect to the supOS platform.<br/>
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/4.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/5.gif)
## Checking Connection
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/collectorDemo/6.gif)
