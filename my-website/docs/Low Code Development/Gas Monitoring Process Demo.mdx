...
:::
![](https://wordpressfreezonex.oss-accelerate.aliyuncs.com/demo/2.png)
4. Click **OK**.
...
1. On supOS platform, select **Business Designer** > ![](https://wordpressfreezonex.oss-accelerate.aliyuncs.com/demo/3.png) to add a new application.
