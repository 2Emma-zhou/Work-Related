...
:::
## Operation Process
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/6.png)
...
2. Select **Object Model Management** > **Object Template** > **Form Template**, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/factoryModeling/26.png) to add a sales order template.<br/>
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/10.png)
...
In the **Attributes** tab, click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/7.png) corresponding to each attribute to add a value.
:::info
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/9.png)
...
<img src="https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/6.gif" />
...
<img src="https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/7.gif" />

4. Add a sales order page.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/12.png)

<ul>
<li>Add the form template to be the table data source and set corresponding headers with attributes.</li>

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/8.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/9.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/10.gif)


<li>Add a <strong>Click</strong> event to the <strong>Add</strong> button and link it to <strong>Add Order</strong> page.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/11.gif)
...
:::
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/12.gif)

5. Save the pages and go back to the **Business Designer** page, and then publish the application of sales order.
## Demo Effect
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/13.gif)
