...
## Operation Process
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/13.png)
...
2. Select **Object Model Management** > **Object Template** > **Entity Template**, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/factoryModeling/26.png) to add a sales order template.<br/>
...
if(auditDataJson.reject===false){  //save approved data
    templates["emma_sales.sales_order"].addDataTableEntry(formDataJson);
}
...
result;
```
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/14.gif)

## Creating Sales Order Page
Create a page to add new sales order. For details, see <a href="add_order">Add Sales Order</a>.
...
:::info
The workflow is very simple with only two steps where a new order is added and approved. Actual workflow might requires more complex steps.
:::
- Draw the workflow.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/15.gif)
- Add the **Add Order** page to the first step.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/16.gif)
- Add the **Add Order** page to the second step for review and the object service for approval.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/17.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/14.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/18.gif)
3. Save the page.

## Demo Effect
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/19.gif)
