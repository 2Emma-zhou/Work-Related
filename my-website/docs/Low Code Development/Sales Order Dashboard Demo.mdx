...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/20.png)
## Operation Process
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/18.png)
...
3. Click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/19.png) at the upper-right corner of the canvas to upload a background image for the block.
4. Add a bar chart to the canvas, and select the **salesVolumeByCity** service as its data source.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/29.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/30.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/31.gif)
4. Link the radio button to the area chart.

![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/32.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/24.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/21.png)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/22.png)
...
```
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/33.gif)
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/23.png)
...
## Demo Effect
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/34.gif)