...
## Operation Process
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/15.png)
...
:::info
For connecting data from third-party database, see <a href="../Using supOS/Factory Modeling/Third-party Database Connection">Third-party Database Connection</a>.
:::
1. Log in to supOS platform, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/platform/7.png) to go to the design center.
2. Select **Object Model Management** > **Object Template** > **Form Template**, and then click ![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/factoryModeling/26.png) to add a sales template.<br/>
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/17.png)
...
:::
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/20.gif)
...
:::
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/21.gif)
...
result;
```
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/22.gif)
...
2. Add a new page.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/16.png)
:::info
Data in this example is for reference only.
:::
- Add data from **Data** service to the report.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/23.gif)
:::info
...
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/24.gif)
- Link the drop-down list to the report.
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/25.gif)
- Add script to **Export** button.
```
var report = scriptUtil.getRegisterReactDom('<em>component ID of report</em>').report; //get data from the report element
report.doExport('xlsx');
```
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/26.gif)
3. Save the page.

## Demo Effect
![](https://wordpressfreezonex.oss-cn-hangzhou.aliyuncs.com/demo/27.gif)
