...
## Get All Events
Comprehensive event search API, and it can run complex filters on events to get corresponding results.

- Path Example code
```
http://192.168.31.125:1235/open-api/supos/oodm/v2/events
```
