...
- Path Example code
```
http://192.168.31.125:1235/open-api/supos/oodm/v2/alerts/history/{alertRecordId}
```
...
- Path Example code
```
http://192.168.31.125:1235/open-api/supos/oodm/v2/alerts/history
```
- Query parameters
The returned data is sorted in descending order based on the alarm triggering time and only return 20 records.
<table>
